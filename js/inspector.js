...
class Inspector {
    ...
    bindInputs() {
        ...
        if (imgLabel) {
            imgLabel.addEventListener('input', () => this.applyChanges());
        }
    ...
    updateSelectionFields() {
        ...
        if (el.type === 'text') {
            ...
            document.getElementById('sel-font-size').value = el.fontSize || 12;
        ...
        if (el.type === 'point') {
            ...
            document.getElementById('sel-point-font-size').value = el.fontSize || 12;
        }
    }
